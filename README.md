...
- **گزارش‌ها — `IMPLEMENTED` (لایهٔ ایرانی ۱۳/۱۳):** فروش/خرید/چک/طرف حساب/مالیات بر ارزش افزوده/دفتر کل/تراز آزمایشی/موجودی کالا/کاردکس/بانک/جریان وجوه نقد/سود و زیان/ترازنامه — همه با سوئیت ران‌تایم سبز روی سایت تازه + ممیزی ۱۳گانهٔ populated/empty-state/blocked-guest (2026-09-21). جزئیات: [`docs/REAL-CURRENT-GAP-MATRIX.md`](docs/REAL-CURRENT-GAP-MATRIX.md).
