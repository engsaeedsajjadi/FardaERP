...
- Full live regression re-run after the lint cleanup (each suite its own process):
  ...
  + Print 9 + Dash 6 + Stock Balance 6 + کاردکس 1 + Financials 4 + Reports Audit 27 (13 reports × populated/empty-state + guest-block, 2026-09-21) = **123 runtime asserts PASS**.
